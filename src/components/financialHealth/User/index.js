  ...
  render() {
    ...
    return (
      <div className="user_form">
        ...
        {/* <div>{this.UserFormRender()}</div> */}

        
      {current === 1 ? <Tabs defaultActiveKey="1" onChange={callback} 
                tabBarStyle={{color:'white', backgroundColor:'#62635D',height: '10vh'}}
          >
            <TabPane tab="Applicant 1" key="1" >
    <UserForm1 allState={this.state} thisObject={this} />;
    </TabPane></Tabs>

     :
      <><Tabs defaultActiveKey="1" onChange={callback} 
      tabBarStyle={{color:'red', backgroundColor:'#62635D',height: '10vh'}}
><TabPane tab="Applicant 1" key="1" >
      <UserForm1 allState={this.state} thisObject={this} />;
      </TabPane>
      <TabPane tab="Applicant 2" key="2">
      <UserForm1 allState={this.state} thisObject={this} />;
      </TabPane></Tabs></>
    }
