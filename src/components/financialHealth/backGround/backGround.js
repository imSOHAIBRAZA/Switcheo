...
function BackGround(props) {
  const [questions, setQuestions] = useState({
    ...
    natureOfConstuction: "",
    natureOfConstuctionValidation: "",
    natureOfConstuctionHelp: "",
    natureOfConstuctionValidationStatus: "error",
      ...
      <Row className="fh-row-gs">
        ...
        <Col lg={24} className="q1 q3">
          ...
          >
            ...
            onClick={clickRadio}
            className={
              questions.purposeOfMortgage === "Property"
                ? "radio-container container_malta"
                : "radio-container"
            }
          >
            <input
              ...
              value="Property"
            />
            <label for="mortf3">Looking for investment property</label>
          </div>
           ...
           <Col lg={24} className="col3">
          <p className="heading3">Nature of construction?</p>
        </Col>
        <Col lg={24} className="q1 q3">
          <div
            onClick={e => clickRadio(e)}
            className={
              questions.natureOfConstuction === "Looking for investment property"
                ? "radio-container container_malta"
                : "radio-container"
            }
          >
            <input
              onChange={e => handleQ(e)}
              type="radio"
              name="natureOfConstuction"
              id="conf"
              className=""
              checked={questions.natureOfConstuction === "Looking for investment property"}
              value="Looking for investment property"
            />
            <label for="conf">Looking for investment property</label>
          </div>

          <div
            onClick={clickRadio}
            className={
              questions.natureOfConstuction === "Second hand home"
                ? "radio-container container_malta"
                : "radio-container"
            }
          >
            <input
              ...
              name="natureOfConstuction"
              id="conf1"
              checked={questions.natureOfConstuction === "Second hand home"}
              className=""
              value="Second hand home"
            />
            <label for="conf1">Second hand home</label>
          </div>
          <div
            onClick={clickRadio}
            className={
              questions.natureOfConstuction === "Self build"
                ? "radio-container container_malta"
                : "radio-container"
            }
          >
            <input
              ...
              value="Self build"
            />
            <label for="conf2">Self build </label>
          </div>
 </Col>
 ...
 <Col lg={24} className="col2">
          <h1 className="heading1">Lets Get Started Back Ground</h1>
